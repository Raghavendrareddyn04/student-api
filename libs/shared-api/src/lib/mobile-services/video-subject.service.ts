...
export class MobileVideoSubjectService {
  ...
  async findVideosByUuid(req, videoUuid: string): Promise<VideoSubject> {
    const testPressToken =
      'eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VybmFtZSI6MSwidXNlcl9pZCI6MSwiaW5zdGl0dXRlIjoxNzUxLCJpZCI6MSwiZXhwIjoxNjcyMzE3ODM4LCJlbWFpbCI6InBsYXRvb2ZmaWNpYWxAcGxhdG9vbmxpbmUuY29tIn0.HYP2eimIORjlt2x1ATrvLTASefmh2Aq_afykeW6AqwU';
